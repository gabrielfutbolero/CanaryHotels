...
<head>
    ...
    <title>Cueva Marina | Canary Hotels</title>
...
<body>
    <div class="contenedor">
        ...
        <div class="banner cueva-marina-norte">
            <div class="banner-container">
                ...
                <div class="banner-text">
                    <div class="head">CUEVA MARINA NORTE</div>
                    <div class="lead">Vive la experiencia en familia</div>
                </div>
        ...
        <div class="hotel-about">
            ...
            <p>
                Este hotel de 570m² permite disfrutar de la experiencia Cueva Marina en familia. Un espacio amplio con vistas a la piscina que se convertirá en tu hogar el tiempo que te quedes con nosotros.
            </p>
        </div>
        ...
        <div class="rooms">
            ...
            <div class="room text-center">
                ...
                <h3>PREMIUM CLOUD</h3>
                <p>La calidez de Lanzarote a tan sólo un click. No esperes más para reservar tu merecido descanso.</p>
                <div class="button button-read">
                    <a href="../es/premium-cloud.php">VER HABITACIÓN</a>
                </div>
            </div>

            <div class="room text-center">
                <span class="iconic"><a href="../img/Galeria/apart8.jpg" title="DUPLEX FAMILY"><img src="../img/Galeria/apart8.jpg"></a></span>
                <h3>DUPLEX FAMILY</h3>
                <p>Nuestro apartamento, la magia de Gran Canaria y tú: así son las vacaciones que siempre imaginaste.</p>
                <div class="button button-read">
                    <a href="../es/duplex-family.php">VER HABITACIÓN</a>
                </div>
            </div>
            ...
            <div class="room text-center">
                ...
                <p>Calma, el mar y la belleza innata de Gran Canaria. ¿Qué más se puede pedir?</p>
                <div class="button button-read">
                    <a href="../es/majoras-premium.php">VER HABITACIÓN</a>
                </div>
            </div>
        </div>
        ...
        <div class="servicios-sec text-center">
            ...
            <div class="content_servicios servicio1">
                ...
                <div class="content medium-width">
                    ...
                    <p class="text_content">Disponemos de instalaciones spa que le transportarán a un mundo de bienestar y relax. Además contamos con un moderno gimnasio donde mantenerse en forma.</p>
                </div>
            ...
            <div class="content_servicios margin-top-cero servicio1">
                <div class="content medium-width">
                    <h3 class="rule">GASTRONOMIA</h3>
                    <p class="text_content">Ofrecemos un amplio abanico de posibilidades gastronómicas en nuestros diferentes enclaves, idóneos para disfrutar además de actuaciones en directo cada noche, salas de televisión con canal satélite... </p>
                </div>
