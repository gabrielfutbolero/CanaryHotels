...
<head>
    ...
    <title>Duplex airwind | Canary Hotels</title>
        ...
        <div class="swiper-container mySwiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="../img/apartamentos/apt38.jpg" alt="Canary Hotels">
                </div>
                <div class="swiper-slide">
                    <img src="../img/apartamentos/apt39.jpg" alt="Canary Hotels">
                </div>
                <div class="swiper-slide">
                    <img src="../img/apartamentos/apt40.jpg" alt="Canary Hotels">
                </div>
                <div class="swiper-slide">
                    <img src="../img/apartamentos/apt41.jpeg" alt="Canary Hotels">
                </div>
                <div class="swiper-slide">
                    <img src="../img/apartamentos/apt42.jpg" alt="Canary Hotels">
                </div>
