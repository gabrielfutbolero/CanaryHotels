...
<head>
    ...
    <title>Duplex gran arco | Canary Hotels</title>
    ...
    <link rel="stylesheet" media="screen" href="../css2/ftr.css">
       ...
       <!-- SLIDE DE IMAGENES -->
        <div class="swiper-container mySwiper">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <img src="../img/apartamentos/apt8.jpg" alt="Canary Hotels">
                </div>
                <div class="swiper-slide">
                    <img src="../img/apartamentos/apt9.jpg" alt="Canary Hotels">
                </div>
                <div class="swiper-slide">
                    <img src="../img/apartamentos/apt10.jpg" alt="Canary Hotels">
                </div>
                <div class="swiper-slide">
                    <img src="../img/apartamentos/apt12.jpg" alt="Canary Hotels">
                </div>
