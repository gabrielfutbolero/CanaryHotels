...
<head>
    ...
    <title>Duplex family | Canary Hotels</title>
        ...
        <div class="swiper-container mySwiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="../img/apartamentos/apt23.jpg" alt="Canary Hotels">
                </div>
                <div class="swiper-slide">
                    <img src="../img/apartamentos/apt24.jpg" alt="Canary Hotels">
                </div>
                <div class="swiper-slide">
                    <img src="../img/apartamentos/apt25.jpg" alt="Canary Hotels">
                </div>
                <div class="swiper-slide">
                    <img src="../img/apartamentos/apt26.jpg" alt="Canary Hotels">
                </div>
                <div class="swiper-slide">
                    <img src="../img/apartamentos/apt27.jpg" alt="Canary Hotels">
                </div>
