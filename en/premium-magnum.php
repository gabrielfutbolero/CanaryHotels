...
<head>
    ...
    <title>Premium magnum | Canary Hotels</title>
       ...
       <!-- SLIDE DE IMAGENES -->
        <div class="swiper-container mySwiper">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <img src="../img/apartamentos/apt14.jpg" alt="Canary Hotels">
                </div>
                <div class="swiper-slide">
                    <img src="../img/apartamentos/apt15.jpg" alt="Canary Hotels">
                </div>
                <div class="swiper-slide">
                    <img src="../img/apartamentos/apt16.jpg" alt="Canary Hotels">
                </div>
                <div class="swiper-slide">
                    <img src="../img/apartamentos/apt17.jpg" alt="Canary Hotels">
                </div>
